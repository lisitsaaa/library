...
alter table if exists journal
    add constraint reader_id_FK_journal foreign key (reader_id) references library_users;

alter table if exists journal_book
    add constraint book_id_FK_journal_book foreign key (book_id) references book;

alter table if exists journal_book
    add constraint journal_id_FK_journal_book foreign key (journal_id) references journal;
